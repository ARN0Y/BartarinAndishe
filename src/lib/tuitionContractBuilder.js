...
export function buildTuitionContractFields({
  ...
  return {
    ...
    bankAccount: settings.bankAccount || tuitionContractMeta.bankAccount,
    bankName: settings.bankName || tuitionContractMeta.bankName,
    accountHolder: settings.accountHolder || tuitionContractMeta.accountHolder,
    accountNationalId: settings.accountNationalId || tuitionContractMeta.accountNationalId,
